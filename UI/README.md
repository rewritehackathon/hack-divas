# Smart Workplace HTML5 Admin Template
**Smart Workplace** is a responsive Bootstrap 4 Admin Template. It provides you with a collection of ready to use code snippets and utilities, custom pages, a collection of applications and some useful widgets. Preview of this awesome admin template available here: https://colorlib.com/polygon/Smart Workplace/index.html

# Preview

### Screenshot

![Smart Workplace admin dashboard template preview](https://colorlib.com/wp/wp-content/uploads/sites/2/Smart Workplace-free-admin-dashboard-template.jpg)

### Demo Site: [Here](https://colorlib.com/polygon/Smart Workplace/index.html)
...
## Getting Started
In order to run **Smart Workplace** on your local machine all what you need to do is to have the prerequisites stated below installed on your machine and follow the installation steps down below.
...
Start by typing the following commands in your terminal in order to get **Smart Workplace** full package on your machine and starting a local development server with live reload feature.

```
> git clone https://github.com/puikinsh/Smart Workplace-admin-dashboard.git Smart Workplace
> cd Smart Workplace
> npm install
> npm run dev
```
...
Smart Workplace is licensed under The MIT License (MIT). Which means that you can use, copy, modify, merge, publish, distribute, sublicense, and/or sell copies of the final products. But you always need to state that Colorlib is the original author of this template.
